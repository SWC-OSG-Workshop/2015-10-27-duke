...
*    If you have an account on Duke CI Connect but forgot the password, [click here](http://duke.ci-connect.net/password). 
...
(including the working directory) and how to start a Python interpreter
before tackling this lesson. This lesson references the IPython
Notebook although it can be taught through any Python interpreter. The
commands in this this lesson pertain to Python 2.7.

### Getting ready

If you are following these lessons on your own computer, you will
eed to download some files:

~~~
$ git clone https://github.com/SWC-OSG-Workshop/ExampleData.git
~~~

We host the IPython server for training here:
https://ipython.osgconnect.net/swc-duke .  You will need to log in with
your Duke CI Connect account.
